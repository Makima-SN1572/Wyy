<template>
  ...
  <div class="detailTop">
    <div class="detailTopLeft">
      ...
      <div class="leftMarquee">
        <Vue3Marquee style="color: aliceblue">
          {{ musicList.al.name }}
        </Vue3Marquee>
  ...
  <div class="detailFooter">
    <div class="footerTop">
      ...
      <svg class="icon" aria-hidden="true">
        <use xlink:href="#icon-24gl-repeatDot2"></use>
      </svg>
    </div>
    ...
    <div class="footer">
      ...
      <svg class="icon" aria-hidden="true">
        <use xlink:href="#icon-zuojiantou" @click="goPlay(-1)"></use>
      </svg>
      <svg
        class="icon bofang"
        aria-hidden="true"
      ...
      <svg class="icon" aria-hidden="true">
        <use xlink:href="#icon-youjiantou" @click="goPlay(1)"></use>
      </svg>
      <svg class="icon" aria-hidden="true">
...
export default {
  ...
  mounted() {
    ...
    //console.log(this.lyricList.lyric);//歌词在控制台打印
    this.addDuration()
  },
